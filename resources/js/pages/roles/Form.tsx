      ...
      <div className="flex-1 p-4 md:p-6 lg:p-8">
        <div className="max-w-4xl mx-auto">
          <PageHeader
            ...
            description={isEdit ? 'Modify role permissions and access levels.' : 'Define a new role and its associated permissions across the system.'}
            className="mb-6"
          />
              ...
              <form onSubmit={handleSubmit} className="space-y-8 pb-4">
                <div className="space-y-6">
                  <div className="grid gap-2">
                    <Label htmlFor="name" className="text-sm font-semibold tracking-wide uppercase text-neutral-500">Role Name</Label>
                    <Input
                      id="name"
                      placeholder="e.g. Editor, Manager, Reviewer"
                      value={data.name}
